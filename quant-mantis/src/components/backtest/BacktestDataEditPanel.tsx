...
export const BacktestDataEditPanel = forwardRef<BacktestDataEditPanelRef, BacktestDataEditPanelProps>(
    ({ initialValues }, ref) => {
        ...
        useEffect(() => {
            ...
            const sql = buildBacktestSQL_v2(sourceDef as Preset)
            setPreviewSql(sql ? sql: "")
