...
class IfindApi:
    ...
    def get_historical_data(
            ...
            indicators: str = "open,close,high,low,volume,amount,changeRatio,turnoverRatio") -> pd.DataFrame | None:    # noqa
        ...
        success, df = convert_to_df(thsResponse.content)
        if success:
            return df
        else:
            return None
